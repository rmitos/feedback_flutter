...
class FeedbackWidgetState extends State<FeedbackWidget> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final ThemeData theme = ThemeData(brightness: feedbackThemeData.brightness, cardColor: feedbackThemeData.feedbackSheetColor, colorScheme: feedbackThemeData.colorScheme);
                            ...
                            child: Padding(
                              ...
                              child: ScaleAndFade(
                                ...
                                child: ControlsColumn(
                                  ...
                                  onControlModeChanged: (FeedbackMode mode) {
                                    setState(() {
                                      this.mode = mode;
                                      _hideKeyboard(context);
                                    });
                          ...
                          LayoutId(
                            ...
                            child: NotificationListener<DraggableScrollableNotification>(
                              onNotification: (notification) {
                                sheetProgress.value = (notification.extent - notification.minExtent) / (notification.maxExtent - notification.minExtent);
                                return false;
                              },
